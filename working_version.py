...
rows = 10
s = snake((0, 255, 0), (2, 2))
speed = 20 # from 1 (painfully slow) to 1000 (impossibly fast) 
timeout = 50
AI = True
#####
...
def A_Star_Decider (snack_loc, s, width):
    ...
    # print("OPTIONS (min-dist):", options)
    ...
    # print ("HEAD: {}\t LENGTH: {}".format(s.body[0].pos, len(illegal_body)))
    # # # # # print ("WALLS: {}".format(illegal_walls))
    # # # # # print("Distances:", distances)
    # # # # # print("Options:", options)
    # print("ALLOWABLE (pre-second): {}".format(allowable))
    ...
    # print("DIRECTIONS: {}".format(direction)) # read as 0123 = LRUD
    ...
    # print("GOAL:", snack_loc)
    # print("DIRECTION_post-wall: {}".format(direction_final)) # read as 0123 = LRUD
    if len(direction_final) < 1:
        terminate(0)
    else:
        # print("DIRECTION_final-call: {}\n".format(direction_final[0])) # read as 0123 = LRUD
...
def game_start(): 
    ...
    while flag:
        ...
        cycle_number += 1
        # print("Cycle number: {}\t Cycle limit: {}".format(cycle_number, timeout), flush=True)
        body = []
